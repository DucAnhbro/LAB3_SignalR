...
namespace Lab3.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdId,ProdName,Catefory,UnitPrice,StockQty")] Products products)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdId,ProdName,Catefory,UnitPrice,StockQty")] Products products)
        {
